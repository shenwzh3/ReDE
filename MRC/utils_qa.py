...
def postprocess_qa_predictions(
    ...
    for i, feature in enumerate(features):
        features_per_example[example_id_to_index[feature["example_id"]]].append(i) # the mapping from example index to feature index
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        for feature_index in feature_indices:
            ...
            start_indexes = np.argsort(start_logits)[-1 : -n_best_size - 1 : -1].tolist() # top n start_indices
            end_indexes = np.argsort(end_logits)[-1 : -n_best_size - 1 : -1].tolist() # top n end_indices
